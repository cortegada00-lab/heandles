...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-50 lg:hidden pb-safe">
      <div className="flex justify-around items-center h-16">
        
        {/* Home */}
        <Link href="/">
          <div className={`flex flex-col items-center justify-center w-full h-full cursor-pointer ${isActive('/') ? 'text-primary' : 'text-gray-500'}`}>
        ...
        <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
            <SheetTrigger asChild>
                <div className={`flex flex-col items-center justify-center w-full h-full cursor-pointer ${isMenuOpen ? 'text-primary' : 'text-gray-500'}`}>
        ...
        {/* Offers */}
        <Link href="/ofertas">
          <div className={`flex flex-col items-center justify-center w-full h-full cursor-pointer ${isActive('/ofertas') ? 'text-red-600' : 'text-gray-500'}`}>
        ...
        <Link href={user ? "/account" : "/login"}>
          <div className={`flex flex-col items-center justify-center w-full h-full cursor-pointer ${isActive('/account') || isActive('/login') ? 'text-primary' : 'text-gray-500'}`}>
