...
import { Mail, Facebook, Instagram, Youtube, MapPin, ArrowRight, CreditCard, Phone, Gift, Star, Snowflake, UserCircle, ToggleLeft } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-foreground font-sans flex flex-col relative">
      <SeoHead 
        title="IVAPEO - Tu Tienda de Vapeo Online nº1 en España" 
